...
SELECT projet_date_depot, projet_superficie_totale, projet_prix, COUNT(participer.emp_matricule)
FROM projets
JOIN employes ON employes.emp_matricule = projets.emp_matricule
JOIN participer ON participer.emp_matricule = projets.emp_matricule
JOIN fonctions ON fonctions.fonction_id = employes.fonction_id
...
SELECT projet_date_depot, projet_prix, client_nom, client_telephone, adresse_ville
FROM projets
JOIN clients ON clients.client_ref = projets.client_ref
